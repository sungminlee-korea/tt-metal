...
void bind_reshape_view(pybind11::module& module, const data_movement_operation_t& operation, const char* doc) {
    bind_registered_operation(
        ...
        ttnn::pybind_overload_t{
            [](const data_movement_operation_t& self,
               const ttnn::Tensor& input_tensor,
               const std::array<int32_t, 1>& new_shape
               ) -> ttnn::Tensor {
        ...
        ttnn::pybind_overload_t{
            [](const data_movement_operation_t& self,
               const ttnn::Tensor& input_tensor,
               const std::array<int32_t, 2>& new_shape
               ) -> ttnn::Tensor {
                return self(input_tensor, ttnn::Shape(new_shape));
            },
            py::arg("input_tensor"),
        ...
        ttnn::pybind_overload_t{
            [](const data_movement_operation_t& self,
               const ttnn::Tensor& input_tensor,
               const std::array<int32_t, 3>& new_shape
               ) -> ttnn::Tensor {
                return self(input_tensor, ttnn::Shape(new_shape));
            },
            py::arg("input_tensor"),
        ...
        ttnn::pybind_overload_t{
            [](const data_movement_operation_t& self,
               const ttnn::Tensor& input_tensor,
               const std::array<int32_t, 4>& new_shape
               ) -> ttnn::Tensor {
                return self(input_tensor, ttnn::Shape(new_shape));
            },
            py::arg("input_tensor"),
        ...
        ttnn::pybind_overload_t{
            [](const data_movement_operation_t& self,
               const ttnn::Tensor& input_tensor,
               const std::array<int32_t, 5>& new_shape
               ) -> ttnn::Tensor {
                return self(input_tensor, ttnn::Shape(new_shape));
            },
            py::arg("input_tensor"),
