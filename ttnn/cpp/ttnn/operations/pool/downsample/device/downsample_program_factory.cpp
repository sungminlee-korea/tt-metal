...
operation::ProgramWithCallbacks downsample_single_core(
    ...
    uint32_t halo_prev_input_cb_index = tt::CB::cb_1;
    ...
    uint32_t halo_next_input_cb_index = tt::CB::cb_2;
    ...
    uint32_t reader_pattern_array_cb_index = tt::CB::cb_25;
    ...
    uint32_t untilize_cb_index = tt::CB::cb_26;
    ...
    uint32_t untilize_downsampled_cb_index = tt::CB::cb_27;
    ...
    uint32_t final_tilize_output_cb_index = tt::CB::cb_16;
