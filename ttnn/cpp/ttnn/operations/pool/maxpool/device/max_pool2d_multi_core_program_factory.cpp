...
MaxPool2D::MultiCore::cached_program_t max_pool_2d_multi_core_sharded_with_halo_v2_impl_new(
    ...
    uint32_t in_scalar_cb_id = tt::CB::cb_4;
    ...
    // reader indices
    auto in_reader_indices_cb_id = tt::CB::cb_3;
    ...
    uint32_t in_cb_id_0 = tt::CB::cb_0;  // input rows for "multiple (out_nelems)" output pixels
    uint32_t in_cb_id_1 = tt::CB::cb_1;  // input rows for "multiple (out_nelems)" output pixels
    ...
    uint32_t in_tiled_cb_id = tt::CB::cb_24;  // tiled input
    ...
    if (is_large_kernel) {
        uint32_t max_pool_partials_cb_id = tt::CB::cb_25;  // max_pool partials
    ...
    uint32_t out_cb_id = tt::CB::cb_16;  // output rows in RM
    // after reduction
