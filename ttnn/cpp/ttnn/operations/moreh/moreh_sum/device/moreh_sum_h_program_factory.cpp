...
MorehSumOperation::MorehSumHFactory::cached_program_t MorehSumOperation::MorehSumHFactory::create(
    ...
    uint32_t scaler_cb_index = tt::CB::cb_2;
    ...
    tt::tt_metal::CircularBufferConfig cb_mask_h_config =
        tt::tt_metal::CircularBufferConfig(mask_h_single_tile_size, {{tt::CB::cb_3, mask_h_cb_data_format}})
            .set_page_size(tt::CB::cb_3, mask_h_single_tile_size);
