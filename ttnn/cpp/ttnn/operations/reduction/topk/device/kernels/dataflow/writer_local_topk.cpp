...
void kernel_main() {
    ...
    constexpr uint32_t values_cb_index = tt::CB::cb_16;
    constexpr uint32_t output_ind_cb_index = tt::CB::cb_17;


    constexpr uint32_t topk_local_values_cb_index = tt::CB::cb_24;
    constexpr uint32_t topk_local_indices_cb_index = tt::CB::cb_25;


    constexpr uint32_t final_values_cb_index = tt::CB::cb_26;
    constexpr uint32_t final_indices_cb_index = tt::CB::cb_27;
