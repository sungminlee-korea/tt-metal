...
operation::ProgramWithCallbacks moe_single_core_interleaved(const Tensor &input_tensor, const Tensor &expert_mask_tensor, const Tensor &topk_mask_tensor, const uint16_t k, Tensor &out_tensor) {
    ...
    uint32_t expert_mask_cb_index = tt::CB::cb_1;
    ...
    uint32_t topk_mask_cb_index = tt::CB::cb_2;
    ...
    uint32_t scale_cb_index = tt::CB::cb_3;
    ...
    uint32_t index_cb_index = tt::CB::cb_24;
    ...
    uint32_t input_transposed_cb_index = tt::CB::cb_25;
    ...
    uint32_t index_transposed_cb_index = tt::CB::cb_26;
    ...
    // topk values
    uint32_t values_cb_index = tt::CB::cb_27;
    ...
    // topk indices
    uint32_t output_ind_cb_index = tt::CB::cb_28;
    ...
    uint32_t cb_cur_max_index = tt::CB::cb_29;
    ...
    uint32_t cb_cur_sum_index = tt::CB::cb_30;
    ...
    // OUTPUT CBs
    uint32_t out_cb_index = tt::CB::cb_16;
