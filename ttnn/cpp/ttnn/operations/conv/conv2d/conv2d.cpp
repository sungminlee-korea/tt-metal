...
OptimizedConvParallelizationConfig determine_conv_op_parallel_config_from_conv_output_mem_config(
    ...
    std::cout << "shard shape = " << shard_shape[0] << std::endl;
    std::cout << "shard shape 1 = " << shard_shape[1] << std::endl;
    return {
...
OptimizedConvBlockConfig determine_per_core_conv_block_config(
    ...
    uint32_t act_block_h_ntiles = act_block_h_override > 0 ? act_block_h_override / tt::constants::TILE_HEIGHT
