...
struct OptimizedConvNew {
    ...
    OptimizedConvNew(const sliding_window::SlidingWindowConfig& sliding_window_config,
        ...
        const DeviceComputeKernelConfig compute_kernel_config, bool enable_act_double_buffer, bool enable_split_reader, bool enable_subblock_padding, bool use_max_cores) :
