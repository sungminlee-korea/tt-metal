...
operation::ProgramWithCallbacks rotary_embedding_multi_core(
    ...
    uint32_t input_cb_index = CB::cb_0;
    ...
    uint32_t rotated_input_cb_index = CB::cb_1;
    ...
    uint32_t src_scalar_cb_index = CB::cb_4;
    ...
    uint32_t rotated_input_interm_cb_index = CB::cb_24;
    ...
    uint32_t cos_interm_cb_index = CB::cb_25;
    ...
    uint32_t sin_interm_cb_index = CB::cb_26;
    ...
    uint32_t untilized_cos_interm_cb_index = CB::cb_27;
    uint32_t untilized_cos_sync_cb_index = CB::cb_5;
    uint32_t untilized_sin_interm_cb_index = CB::cb_28;
    uint32_t untilized_sin_sync_cb_index = CB::cb_6;
    uint32_t retilized_cos_cb_index = CB::cb_29;
    uint32_t retilized_sin_cb_index = CB::cb_30;
