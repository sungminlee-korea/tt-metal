...
void kernel_main() {
    ...
    constexpr uint32_t cb_inq  = tt::CB::cb_0;
    constexpr uint32_t cb_inkv = tt::CB::cb_1;

    constexpr uint32_t cb_outq = tt::CB::cb_16;
    #ifdef TRANSPOSE_K_HEADS
    constexpr uint32_t cb_outk = tt::CB::cb_24;
    #else
    constexpr uint32_t cb_outk = tt::CB::cb_17;
    #endif
    constexpr uint32_t cb_outv = tt::CB::cb_18;
