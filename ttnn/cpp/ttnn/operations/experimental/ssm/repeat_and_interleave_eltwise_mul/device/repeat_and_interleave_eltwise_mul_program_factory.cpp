...
operation::ProgramWithCallbacks multi_core_ssm_eltwise_mul(
    ...
    uint32_t cb_intermed0_index = tt::CB::cb_24;  // cb_in0_transposed
    ...
    uint32_t cb_intermed1_index = tt::CB::cb_25;  // cb_in1_transposed
    ...
    uint32_t cb_intermed2_index = tt::CB::cb_26;  // cb_in1_bcast_row
    ...
    uint32_t cb_intermed3_index = tt::CB::cb_27;  // cb_out_transposed
