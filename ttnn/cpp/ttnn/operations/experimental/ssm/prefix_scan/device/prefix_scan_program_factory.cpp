...
operation::ProgramWithCallbacks multi_core_ssm_prefix_scan(
    ...
    const uint32_t cb_a_tilize_in_id = tt::CB::cb_24;
    ...
    const uint32_t cb_bx_tilize_in_id = tt::CB::cb_25;
    ...
    const uint32_t cb_tilize_out_id = tt::CB::cb_26;
