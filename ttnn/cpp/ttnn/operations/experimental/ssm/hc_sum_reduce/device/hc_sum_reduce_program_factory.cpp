...
operation::ProgramWithCallbacks multi_core_ssm_1d_sum_reduce(
    ...
    const uint32_t input_cb_id = tt::CB::cb_0;
    ...
    const uint32_t scalar_cb_id = tt::CB::cb_2;
    ...
    const uint32_t intermed_cb_id0 = tt::CB::cb_24;
    ...
    const uint32_t intermed_cb_id1 = tt::CB::cb_25;
    ...
    const uint32_t intermed_cb_id2 = tt::CB::cb_26;
    ...
    const uint32_t output_cb_id = tt::CB::cb_16;
