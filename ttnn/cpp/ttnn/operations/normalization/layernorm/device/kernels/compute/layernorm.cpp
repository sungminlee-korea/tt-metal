...
void MAIN {
    ...
    constexpr auto cb_scaler = tt::CB::cb_2; // single tile generated by the reader
    constexpr auto cb_eps = tt::CB::cb_3; // single tile generated by the reader
    constexpr auto cb_in = tt::CB::cb_0; // input x or a for fused pre-add (x=a+b)
    constexpr auto cb_inb = tt::CB::cb_1; // input b for fused pre-add
    constexpr auto cb_out = tt::CB::cb_16; // output
    constexpr auto cb_gamma = tt::CB::cb_5;
    constexpr auto cb_beta = tt::CB::cb_6;
    #if defined RMSNORM and not defined FUSE_PRE_ADD
    constexpr uint32_t cb_xmm = cb_in; // x minus mean
    #else
    constexpr uint32_t cb_xmm = tt::CB::cb_24; // x minus mean
    #endif
    constexpr auto cb_ex = tt::CB::cb_25; // E[x]
    constexpr auto cb_ex2 = tt::CB::cb_26; // E[(x-E[x])^2]
    constexpr auto cb_xmm2 = tt::CB::cb_27; // xmm^2
    constexpr auto cb_ex2pe = tt::CB::cb_28; // E[(x-E[x])^2]+eps
    constexpr auto cb_fusion = tt::CB::cb_29; // stream gamma/beta
    constexpr auto scaler0 = 0;
    #ifdef FUSE_PRE_ADD
    #ifdef RMSNORM
    constexpr uint32_t cb_x = cb_xmm;
    #else
    constexpr uint32_t cb_x = tt::CB::cb_30;
    #endif
    #else
