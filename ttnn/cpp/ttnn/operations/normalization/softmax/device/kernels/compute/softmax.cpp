...
void MAIN {
    ...
    binary_op_init_common(tt::CB::cb_0, tt::CB::cb_2, tt::CB::cb_24);
    ...
    constexpr auto cb_fused_scale = tt::CB::cb_3;
    constexpr auto cb_fused_attn = tt::CB::cb_4;
    constexpr auto cb_mask_padded = tt::CB::cb_5;
    constexpr auto cb_exps = tt::CB::cb_24;
    constexpr auto cb_scale_mask = tt::CB::cb_27;
