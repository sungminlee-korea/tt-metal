...
void MAIN {
    ...
    mm_init(tt::CB::cb_0, tt::CB::cb_1, tt::CB::cb_24);
    ...
    for (uint32_t b = 0; b < batch; b++) {
        ...
        for (uint32_t block = 0; block < num_blocks; block++) {
            ...
            cb_wait_front(tt::CB::cb_0, in0_block_num_tiles);
            cb_wait_front(tt::CB::cb_1, in1_block_num_tiles);
            ...
            for (uint32_t in0_subblock = 0; in0_subblock < in0_num_subblocks; in0_subblock++) {
                ...
                for (uint32_t in1_subblock = 0; in1_subblock < in1_num_subblocks; in1_subblock++) {
                    ...
                    if (enable_reload) {
                        copy_tile_to_dst_init_short_with_dt(tt::CB::cb_1, tt::CB::cb_24);
                        cb_wait_front(tt::CB::cb_24, out_subblock_num_tiles);
                        for (uint32_t i = 0; i < out_subblock_num_tiles; i++) {
                            copy_tile(tt::CB::cb_24, i, i);
                        }
                        cb_pop_front(tt::CB::cb_24, out_subblock_num_tiles);
                        mm_init_short_with_dt(tt::CB::cb_0, tt::CB::cb_1, tt::CB::cb_24);
                    }
                    ...
                    if (last_out) {
                        ...
                        cb_reserve_back(tt::CB::cb_16, out_subblock_num_tiles);
                        for (uint32_t i = 0; i < out_subblock_num_tiles; i++) {
                            pack_tile(i, tt::CB::cb_16);
                        }
                        cb_push_back(tt::CB::cb_16, out_subblock_num_tiles);
                    } else {
                        // Wait for tiles in output buffer to be written out since interm and output share memory
                        if (block == 0) {
                            cb_reserve_back(tt::CB::cb_16, out_num_tiles_to_wait);
                            out_num_tiles_to_wait += out_subblock_num_tiles;
                        }
                        // Move partial result to interm buffer
                        cb_reserve_back(tt::CB::cb_24, out_subblock_num_tiles);
                        for (uint32_t i = 0; i < out_subblock_num_tiles; i++) {
                            pack_tile(i, tt::CB::cb_24);
                        }
                        cb_push_back(tt::CB::cb_24, out_subblock_num_tiles);
                    }
            ...
            cb_pop_front(tt::CB::cb_0, in0_block_num_tiles);
            cb_pop_front(tt::CB::cb_1, in1_block_num_tiles);
        }
    }
}
}  // namespace NAMESPACE
