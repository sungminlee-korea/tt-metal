...
void MAIN {
    ...
    constexpr uint32_t matmul_partials_cb                       = tt::CB::cb_24;
    constexpr uint32_t tilized_in0_cb_id                        = tt::CB::cb_25;
    constexpr uint32_t untilize_mode_final_matmul_partials_cb   = tt::CB::cb_26;
    constexpr uint32_t untilize_mode_reblock_cb                 = tt::CB::cb_27;
    constexpr uint32_t out_cb_id                                = tt::CB::cb_16;
        ...
        constexpr uint32_t out_for_bias_cb_id                   = tt::CB::cb_28;
