...
void MAIN {
    ...
    constexpr auto cb_recip_nrstd = tt::CB::cb_28;  // (1.0 / n) * rstd

    constexpr auto cb_tmp1 = tt::CB::cb_29;  // tmp1
    constexpr auto cb_tmp2 = tt::CB::cb_30;  // tmp2
    constexpr auto cb_tmp3 = tt::CB::cb_31;  // tmp3
