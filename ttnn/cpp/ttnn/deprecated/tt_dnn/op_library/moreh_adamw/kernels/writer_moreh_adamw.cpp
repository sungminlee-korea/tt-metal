...
void kernel_main() {
    ...
    constexpr uint32_t cb_id_param = tt::CB::cb_16;
    constexpr uint32_t cb_id_exp_avg = tt::CB::cb_17;
    constexpr uint32_t cb_id_exp_avg_sq = tt::CB::cb_18;
...
#ifdef AMSGRAD
    constexpr uint32_t cb_id_max_exp_avg_sq = tt::CB::cb_19;
