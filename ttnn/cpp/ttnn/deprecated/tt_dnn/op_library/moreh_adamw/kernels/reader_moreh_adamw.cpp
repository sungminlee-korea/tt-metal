...
void kernel_main() {
    ...
    constexpr uint32_t cb_id_param = tt::CB::cb_0;
    constexpr uint32_t cb_id_grad = tt::CB::cb_1;
    constexpr uint32_t cb_id_exp_avg = tt::CB::cb_2;
    constexpr uint32_t cb_id_exp_avg_sq = tt::CB::cb_3;

    // lr, beta1, beta2, eps, weight_decay
    constexpr uint32_t cb_scalar_args = tt::CB::cb_5;
    constexpr uint32_t cb_id_one = tt::CB::cb_6;
...
#ifdef AMSGRAD
    constexpr uint32_t cb_id_max_exp_avg_sq = tt::CB::cb_4;
