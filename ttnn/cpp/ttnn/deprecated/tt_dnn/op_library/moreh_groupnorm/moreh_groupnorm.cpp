...
operation::ProgramWithCallbacks moreh_groupnorm_impl(
    ...
    CreateCircularBuffer(
        ...
        cb_data_format,
        {
            ...
            {CB::cb_24, im0_t},  // E[x]
            {CB::cb_25, im1_t},  // x - E[x]
            {CB::cb_26, im2_t},  // (x - E[x])^2
            {CB::cb_27, im3_t},  // Sum[(x - E[x])^2]
            {CB::cb_28, im4_t},  // E[(x - E[x])^2] = Var[x]
            {CB::cb_29, im5_t},  // 1.0/(sqrt(Var[x] + eps))
            {CB::cb_30, im6_t},  // y * gamm + beta
            {CB::cb_31, im7_t},  // Sum[x]
        });
