...
#include "ttnn/operations/conv/conv_transpose2d/conv_transpose2d_pybind.hpp"
...
void py_module(py::module& module) {
    ...
    auto m_conv_transpose2d = module.def_submodule("conv_transpose2d", "conv_transpose2d operation");
    conv::conv_transpose2d::py_bind_conv_transpose2d(m_conv_transpose2d);
