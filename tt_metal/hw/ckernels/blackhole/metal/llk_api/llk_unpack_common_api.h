...
template <bool float_only = true, bool is_tile_dim_reconfig_en = false>
inline void llk_unpack_reconfig_data_format_srca(const std::uint32_t srca_new_operand) {
    ...
    _llk_unpack_reconfig_data_format_srca_impl_<float_only>(
...
inline void llk_unpack_reconfig_data_format_srcb(const std::uint32_t srcb_new_operand) {
    ...
    _llk_unpack_reconfig_data_format_srcb_impl_<float_only>(
...
inline void llk_unpack_reconfig_data_format_srca(
    ...
    if ((unpack_src_format[old_srca_operand_id] != unpack_src_format[new_srca_operand_id])) {
        llk_unpack_reconfig_data_format_srca<float_only, is_tile_dim_reconfig_en>(srca_new_operand);
...
inline void llk_unpack_reconfig_data_format_srcb(
    ...
    if ((unpack_src_format[old_srcb_operand_id] != unpack_src_format[new_srcb_operand_id])) {
        llk_unpack_reconfig_data_format_srcb<float_only, is_tile_dim_reconfig_en>(srcb_new_operand);
    } else if constexpr (is_tile_dim_reconfig_en) {
        llk_unpack_reconfig_data_format_srcb<float_only, is_tile_dim_reconfig_en>(srcb_new_operand);
    }
}
...
inline void llk_unpack_reconfig_data_format(
    ...
    llk_unpack_reconfig_data_format_srca<float_only, is_tile_dim_reconfig_en>(srca_old_operand, srca_new_operand);
    llk_unpack_reconfig_data_format_srcb<float_only, is_tile_dim_reconfig_en>(srcb_old_operand, srcb_new_operand);
}
