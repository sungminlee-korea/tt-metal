...
template <DataCopyType type, BroadcastType src_b_bcast_type = BroadcastType::NONE, bool is_fp32_dest_acc_en = false, bool is_int_fpu_en = false, bool tilize = false>
...
inline void llk_math_eltwise_unary_datacopy_init(
    ...
    _llk_math_eltwise_unary_datacopy_init_<type, src_b_bcast_type, tilize, is_fp32_dest_acc_en, is_int_fpu_en>(
        transpose_of_faces,
