...
int main(int argc, char **argv) {
    ...
    constexpr uint32_t src0_cb_index = tt_metal::GetCircularBufferEnum(program, cb_src0);

    constexpr uint32_t src1_cb_index = CB::cb_1;
    ...
    constexpr uint32_t output_cb_index = CB::cb_16;
