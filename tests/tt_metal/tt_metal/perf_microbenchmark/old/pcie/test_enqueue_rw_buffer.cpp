    ...
    try {
        ...
        try {
            std::tie(device_id, input_args) =
                test_args::get_command_option_uint32_and_remaining_args(input_args, "--device_id");
        } catch (const std::exception& e) {
            TT_THROW("Provide device ID with option --device_id");
        }
        ...
        try {
            std::tie(buffer_size, input_args) =
                test_args::get_command_option_uint64_and_remaining_args(input_args, "--buffer_size");
        } catch (const std::exception& e) {
        ...
        try {
            std::tie(page_size, input_args) =
                test_args::get_command_option_uint64_and_remaining_args(input_args, "--page_size");
        } catch (const std::exception& e) {
            TT_THROW("Provide page size with option --page_size");
        }
