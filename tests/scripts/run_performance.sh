...
run_perf_models_other() {
    ...
    if [ "$tt_arch" == "wormhole_b0" ]; then
        ...
        env WH_ARCH_YAML=wormhole_b0_80_arch_eth_dispatch.yaml pytest models/demos/squeezebert/tests/test_performance.py  -m $test_marker
...
run_device_perf_models() {
    ...
    if [ "$tt_arch" == "wormhole_b0" ]; then
        ...
        env WH_ARCH_YAML=wormhole_b0_80_arch_eth_dispatch.yaml pytest models/demos/squeezebert/tests/test_perf_device_squeezebert.py -m $test_marker
    fi
