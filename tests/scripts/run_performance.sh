...
run_perf_models_other() {
    ...
    env pytest models/demos/wormhole/distilbert/tests/test_perf_distilbert.py -m $test_marker
...
run_device_perf_models() {
    ...
    env pytest models/demos/wormhole/distilbert/tests -m $test_marker
