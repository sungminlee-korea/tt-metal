...
def test_moreh_linear(shapes, has_bias, compute_kernel_options, device):
    # TODO: Duong Remove skiptest until PR https://github.com/tenstorrent/tt-metal/pull/12794 is merged and apply fix from duong/fix_moreh_linear_fp32_dest_acc.
