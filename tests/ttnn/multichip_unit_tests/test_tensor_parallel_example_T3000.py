...
def test_tensor_parallel_falcon_mlp(t3k_mesh_device):
    ...
    with ttnn.distribute(ttnn.ReplicateTensorToMesh(t3k_mesh_device)):
    ...
    with ttnn.distribute(ttnn.ConcatMeshToTensor(t3k_mesh_device, dim=3)):
