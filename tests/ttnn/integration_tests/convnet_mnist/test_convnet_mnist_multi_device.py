...
from models.demos.wormhole.functional_convnet_mnist.convnet_mnist_utils import get_test_data
...
def test_convnet_mnist(mesh_device, reset_seeds):
    ...
    test_input, images, output = get_test_data(16)
