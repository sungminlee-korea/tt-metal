...
class Conv2dNormActivation:
    def __init__(
        ...
        self.conv = Conv(
            [stride, stride, padding, padding], parameters[0], activation=act, dilation=dilation, groups=groups
        )  # 0 indicates conv
...
class ttnn_InvertedResidual:
    ...
    def __init__(
        self, cnf: InvertedResidualConfig, se_layer=partial(SElayer, scale_activation=ttnn.hardswish), parameters=None
    ):
        super().__init__()
