...
class MobileNetV2:
    ...
    def __init__(self, parameters: ParameterDict, device, model) -> None:
        ...
        self.c7 = MobileNetV2Conv2D(parameters.c7, parameters.b7, device, activation="")
        ...
        self.c14 = MobileNetV2Conv2D(parameters.c14, parameters.b14, device, activation="", use_1d_systolic_array=False)
        self.c15 = MobileNetV2Conv2D(parameters.c15, parameters.b15, device, use_1d_systolic_array=False)
        self.c16 = MobileNetV2Conv2D(parameters.c16, parameters.b16, device, activation="")
        self.c17 = MobileNetV2Conv2D(parameters.c17, parameters.b17, device, activation="", use_1d_systolic_array=False)
        self.c18 = MobileNetV2Conv2D(parameters.c18, parameters.b18, device, use_1d_systolic_array=False)
        ...
        self.c21 = MobileNetV2Conv2D(parameters.c21, parameters.b21, device, use_1d_systolic_array=False)
        self.c22 = MobileNetV2Conv2D(parameters.c22, parameters.b22, device, activation="", use_1d_systolic_array=False)
        self.c23 = MobileNetV2Conv2D(parameters.c23, parameters.b23, device, activation="", use_1d_systolic_array=False)
        self.c24 = MobileNetV2Conv2D(parameters.c24, parameters.b24, device, use_1d_systolic_array=False)
        self.c25 = MobileNetV2Conv2D(parameters.c25, parameters.b25, device, activation="", use_1d_systolic_array=False)
        self.c26 = MobileNetV2Conv2D(parameters.c26, parameters.b26, device, activation="", use_1d_systolic_array=False)
        self.c27 = MobileNetV2Conv2D(parameters.c27, parameters.b27, device)
        self.c28 = MobileNetV2Conv2D(parameters.c28, parameters.b28, device, activation="", use_1d_systolic_array=False)
        self.c29 = MobileNetV2Conv2D(parameters.c29, parameters.b29, device, activation="", use_1d_systolic_array=False)
        self.c30 = MobileNetV2Conv2D(parameters.c30, parameters.b30, device)
        self.c31 = MobileNetV2Conv2D(parameters.c31, parameters.b31, device, activation="", use_1d_systolic_array=False)
        self.c32 = MobileNetV2Conv2D(parameters.c32, parameters.b32, device, activation="", use_1d_systolic_array=False)
        self.c33 = MobileNetV2Conv2D(parameters.c33, parameters.b33, device)
        self.c34 = MobileNetV2Conv2D(parameters.c34, parameters.b34, device, activation="", use_1d_systolic_array=False)

        self.c35 = model.c35
        self.b35 = model.b35

        self.c36 = MobileNetV2Conv2D(parameters.c36, parameters.b36, device, use_1d_systolic_array=False)
        self.c37 = MobileNetV2Conv2D(parameters.c37, parameters.b37, device, activation="", use_1d_systolic_array=False)

        self.c38 = model.c38
        self.b38 = model.b38

        self.c39 = MobileNetV2Conv2D(parameters.c39, parameters.b39, device)
        self.c40 = MobileNetV2Conv2D(parameters.c40, parameters.b40, device, activation="", use_1d_systolic_array=False)
        ...
        self.c45 = MobileNetV2Conv2D(parameters.c45, parameters.b45, device, use_1d_systolic_array=False)
        self.c46 = MobileNetV2Conv2D(parameters.c46, parameters.b46, device, activation="", use_1d_systolic_array=False)

        self.c47 = model.c47
        self.b47 = model.b47

        self.c48 = MobileNetV2Conv2D(parameters.c48, parameters.b48, device)
        self.c49 = MobileNetV2Conv2D(parameters.c49, parameters.b49, device, activation="", use_1d_systolic_array=False)

        self.c50 = model.c50
        self.b50 = model.b50

        self.c51 = MobileNetV2Conv2D(parameters.c51, parameters.b51, device, use_1d_systolic_array=False)
        self.c52 = MobileNetV2Conv2D(parameters.c52, parameters.b52, device, activation="", use_1d_systolic_array=False)
    ...
    def __call__(
        ...
        output_tensor_c6 = self.input_preprocessor(output_tensor, 1, 32, 32, 32)
        ...
        output_tensor_c6 = output_tensor_c6[:, :24, :, :]
        ...
        output_tensor = ttnn.to_layout(
            output_tensor, layout=ttnn.TILE_LAYOUT, memory_config=ttnn.L1_MEMORY_CONFIG, dtype=ttnn.bfloat8_b
        )
        output_tensor = ttnn.relu6(output_tensor)
        ...
        self.l1_weight = ttnn.to_memory_config(self.l1_weight, ttnn.L1_MEMORY_CONFIG)
