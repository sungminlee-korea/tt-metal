...
def test_demo(input_loc, model_name, distilbert, model_location_generator):
    disable_persistent_kernel_cache()
    disable_compilation_reports()
...
def test_demo_squadv2(model_name, distilbert, n_iterations, model_location_generator, use_program_cache):
    disable_persistent_kernel_cache()
    disable_compilation_reports()
