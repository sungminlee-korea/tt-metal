...
from models.demos.wormhole.functional_convnet_mnist.tt.convnet_mnist import (
    functional_convnet_mnist,
    custom_preprocessor,
)
from models.demos.wormhole.functional_convnet_mnist import convnet_mnist_preprocessing
from models.experimental.convnet_mnist.reference.convnet import ConvNet


def get_expected_times(functional_convnet_mnist):
    return (15.0, 9.2)
...
def test_convnet_mnist(
    ...
    expected_compile_time, expected_inference_time = get_expected_times("functional_convnet_mnist")
    prep_perf_report(
...
def test_perf_device_bare_metal_convnet_mnist(batch_size, expected_perf):
    ...
    command = f"pytest tests/ttnn/integration_tests/convnet_mnist/test_convnet_mnist_multi_device.py"
