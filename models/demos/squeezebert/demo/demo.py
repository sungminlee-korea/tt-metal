...
def run_squeezebert_question_and_answering_inference(
    ...
    ttnn_squeezebert_inputs = bert.preprocess_inputs(
...
def test_demo(input_loc, model_name, bert, device, use_program_cache, reset_seeds):
    disable_persistent_kernel_cache()
    disable_compilation_reports()
...
def test_demo_squadv2(model_name, bert, n_iterations, device, use_program_cache, reset_seeds):
    disable_persistent_kernel_cache()
    disable_compilation_reports()
