...
def get_expected_times(functional_mnist):
    return {
        ttnn_functional_mnist: (10, 0.014),
    }[functional_mnist]
...
@pytest.mark.parametrize(
    "functional_mnist",
    [ttnn_functional_mnist],
)
@pytest.mark.parametrize("device_params", [{"l1_small_size": 32768}], indirect=True)
def test_performance_mnist(mesh_device, batch_size, functional_mnist, model_location_generator):
    ...
    for _ in range(2):
        ...
        ttnn_output = ttnn_functional_mnist.mnist(
